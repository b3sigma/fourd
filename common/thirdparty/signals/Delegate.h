...
// Var args version
// I'm sure this breaks all sorts of the excellent portability code above
//N=N
template<class RetType, typename... TVarParams>
class DelegateN {
private:
	typedef typename detail::DefaultVoidToVoid<RetType>::type DesiredRetType;
	typedef DesiredRetType (*StaticFunctionPtr)(TVarParams... varParams);
	typedef RetType (*UnvoidStaticFunctionPtr)(TVarParams... varParams);
	typedef RetType (detail::GenericClass::*GenericMemFn)(TVarParams... varParams);
	typedef detail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
	ClosureType m_Closure;
public:
	// Typedefs to aid generic programming
	typedef DelegateN type;

	// Construction and comparison functions
	DelegateN() { clear(); }
	DelegateN(const DelegateN &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const DelegateN &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const DelegateN &x) const {
	...
	DelegateN(Y *pthis, DesiredRetType (X::* function_to_bind)(TVarParams... varParams) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	inline void Bind(Y *pthis, DesiredRetType (X::* function_to_bind)(TVarParams... varParams)) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind);	}
	// Binding to const member functions.
	template < class X, class Y >
	DelegateN(const Y *pthis, DesiredRetType (X::* function_to_bind)(TVarParams... varParams) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	inline void Bind(const Y *pthis, DesiredRetType (X::* function_to_bind)(TVarParams... varParams) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X *>(pthis), function_to_bind);	}
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	DelegateN(DesiredRetType (*function_to_bind)(TVarParams... varParams) ) {
		Bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	void operator = (DesiredRetType (*function_to_bind)(TVarParams... varParams) ) {
		Bind(function_to_bind); }
	inline void Bind(DesiredRetType (*function_to_bind)(TVarParams... varParams)) {
		m_Closure.bindstaticfunc(this, &DelegateN::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
